...
<div class="modal fade modal-slide-in-right" aria-hiden="true" role="dialog" tabindex="-1" id="modal-delete-{{$user->IdUsuario}}">

	{{form::Open(array('action'=>array('UsuarioController@destroy',$user->IdUsuario),'method' =>'delete'))}}
