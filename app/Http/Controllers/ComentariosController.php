...
class ComentariosController extends Controller
{
    ...
    public function index(Request $request){
    	...
    	if($request){
	    	...
	    	return view('administrador.comentarios.index',["comentarios"=>$comentarios,"searchText"=>$query]);
    ...
    public function create(){
            ...
            return view("administrador.comentarios.create");
    ...
    public function store(ComentariosFormRequest $request){
        ...
        return Redirect::To('administrador/comentarios');
     ...
     public function edit($IdComments){
        ...
        return view("administrador.comentarios.edit",["comentarios"=>Comentarios::findOrFail($IdComments)]);
